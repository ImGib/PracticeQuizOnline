<%-- 
    Document   : DeleteAccountBySelf
    Created on : Feb 25, 2023, 9:02:48 PM
    Author     : Gib
--%>
                        ...
                        <div class="card-body pt-5">
                            <form action="user-delete-account" method="post">
                                <div class="container-xl px-4 mt-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="card-header">ComFirm Your Account</div>
                                            <div class="card-body">
                                ...
                                <div style=" text-align: center;">
                                    <input class="btn btn-danger-soft text-danger" type="submit" value="I understand, delete my account">
                                </div>
                            </form>
