        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="Profile_Update_App.html" aria-expanded="false">
        ...
        <div class="content-body">
            <div class="container-xl px-4 mt-4">
                <nav class="nav nav-borders">
                    <a class="nav-link  ms-0" href="edit-profile"
                        >Profile</a>
                    <a class="nav-link active" href="Profile_Security_App.html"
                        >Security</a>
                </nav>
                <hr class="mt-0 mb-4">
                <div class="row">
         ...
         <span class="login100-form-title" style="color: red">
                            ${requestScope.mess}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="newPassword" name="pass" type="password"
                                            placeholder="Enter new password">
                                    </div>
        
                                    <div class="mb-3">
                                        <label class="small mb-1" for="confirmPassword">Confirm Password</label>
                                        <input class="form-control" id="confirmPassword" name="repass" type="password"
                    ...
                    <div class="col-lg-4">
                            ...
                            <div class="card-body">
                               <a href="delete-user"><button class="btn btn-danger-soft text-danger" type="submit">I want, delete my
                                account</button></a> 
                            </div>
                    </div>
                </div>
