...
<%-- 
    ...
    Created on : Feb 20, 2023, 1:00:10 PM
    Author     : asus
--%>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="status text-success">&bull;</span> Active</td>
                                    <td>
                                        <a href="Admin_ChangeRole_App.html" class="settings" title="Settings" data-toggle="tooltip"><i
                                                class="material-icons">&#xE8B8;</i></a>
                                        <a href="Admin_DeleteAcount_App.html" class="delete" title="Delete" data-toggle="tooltip"><i
                                                class="material-icons">&#xE5C9;</i></a>
                                    </td>
                                </tr>
                                <tr>
