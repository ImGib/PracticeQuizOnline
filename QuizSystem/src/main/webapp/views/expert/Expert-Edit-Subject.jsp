<%-- 
    Document   : Expert_AddNewSubject
    Created on : Feb 23, 2023, 8:15:38 AM
    Author     : Lenovo
--%>
                                        ...
                                        <div class="card login-form mb-0">
                                            <div class="card-body pt-5">
                                                        ...
                                                        <div class="row gx-3 mb-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input class="form-control" id="inputSubjectName" type="text"
                                                                       value="${requestScope.subject.name}" name="subName" required="">
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row gx-3 mb-3">
                                                        <!-- Form Group (first name)-->
                                                        <div class="col-md-4 pt-1 ml-3" style="font-size: 20px;">
                                                            <span>Choose a category: </span>
                                                        </div>
                                                        <div class="col-md-12 mt-3" style="display: flex; flex-wrap: wrap;">
                                                            <c:forEach items="${requestScope.listC}" var="lc">
                                                                    <div class="col-md-3 ml-5 mt-3" style="display: flex;">
                                                                        <input id="inputSubjectName" name="checkBox" type="checkbox" value="${lc.id}" ${lc.isCheckEd(listS) ? "checked" : ""}><div style="margin-left: 8%; text-align: center;">${lc.name}</div>
                                                                    </div>
                                                            </c:forEach>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row gx-3 mb-3">
                                                        ...
                                                        <div class="col-md-8" style="border: #999898 solid 1px; padding: 0 0;">
                                                            ...
                                                            <textarea type="text" class="form-control"
                                                                      style="height: 250px;" name="description">${requestScope.subject.description}</textarea>
                                                ...
                                                <button type="submit" class="btn submit w-100"
                                                        style="border: #242424 solid 1px; background-color: #3a7893; width: 00px;">Save</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
