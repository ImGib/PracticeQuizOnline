                                    ...
                                    <div class="form-input-content">
                                        <div class="card login-form mb-0">
                                            <div class="card-body pt-5">
                                                <h1 style="text-align: center">New Subject</h1>
                                                        ...
                                                        <div class="row gx-3 mb-3">
                                                            ...
                                                            <c:forEach items="${requestScope.listC}" var="lc">
                                                                <div class="col-md-3 ml-5 mt-3" style="display: flex;">
                                                                    <input id="inputSubjectName" name="checkBox" type="checkbox" value="${lc.id}"><div style="margin-left: 8%; text-align: center;">${lc.name}</div>
                                                                </div>
                                                            </c:forEach>
                                                        </div>
                                                    </div>
