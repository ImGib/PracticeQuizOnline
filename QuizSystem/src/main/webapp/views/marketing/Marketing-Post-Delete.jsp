                                    ...
                                    <div class="container-xl px-4 mt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                    ...
                                                    <div class="card-header">Delete Post ID: ${id}</div>
                                                    <div class="card-body">
                                                        <p style="color: rgb(204, 71, 71);">Deleting your post is a permanent action and cannot be undone. If you are sure you want to
                                                            delete your post, select the button below.</p>
