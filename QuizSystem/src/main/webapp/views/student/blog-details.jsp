<%-- 
    ...
    Created on : Feb 23, 2023, 11:50:12 PM
    Author     : Gib
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>${requestScope.crPost.tittle}</title>
        <meta name="viewport" content="width=device-width, initial-scale=1">
                                    ...
                                    <div class="body">
                                        <div class="img-post">
                                            <img class="d-block img-fluid"
                                                 src="${requestScope.crPost.img}" alt="First slide">
                                        </div>
                                        <h3>${requestScope.crPost.tittle}</h3>
                                        <p>${requestScope.crPost.details}</p>
                                    </div>
                                </div>
                            </div>
