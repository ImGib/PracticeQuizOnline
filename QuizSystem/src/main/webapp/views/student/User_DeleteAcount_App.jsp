<%-- 
    Document   : User_DeleteAcount_App
    Created on : Feb 20, 2023, 12:58:51 PM
    Author     : Lenovo
--%>
                        ...
                        <div class="form-input-content">
                            <div class="card login-form mb-0">
                                <div class="card-body pt-5">
                                    ...
                                    <div style=" text-align: center;"><button class="btn btn-danger-soft text-danger" type="button">I understand, delete my
                                        account</button></div>
                                </div>
                            </div>
                        </div>
