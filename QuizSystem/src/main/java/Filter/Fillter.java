 ...
 * @author asus
 */
@WebFilter(filterName="Fillter", urlPatterns={"/*"})
public class Fillter implements Filter {
	...
	if (debug) log("Fillter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("Fillter:DoAfterProcessing");
...
//                if(role==0)res.sendRedirect("admin");
//                if(role==2)res.sendRedirect("expert-home");
//                if(role==3)res.sendRedirect("marketing-post");
//            }
//            
...
//            }
	...
	if (filterConfig == null) return ("Fillter()");
